...
#block(
  ...
  width: 100%,
  [
    #strong[A Note on Provenance and Identity]
    #v(0.5em)

    #emph[IPWT posits that a conscious system's reality is defined by its verifiable information, not its physical carrier. We apply this principle to the theory itself. ``Rui Lin'' is a deliberate persona; the author's identity is irrelevant to the theory's logical integrity. Its proof-of-existence is immutably timestamped on #link("https://github.com/dmf-archive/IPWT")[GitHub].]

    #emph[A self-consistent system is its own final proof.]
  ],
)

#pagebreak()

= Introduction: Challenges in Consciousness Science and the Necessity of a Unified Framework
<introduction-challenges-in-consciousness-science-and-the-necessity-of-a-unified-framework>
Consciousness, as the most direct yet elusive phenomenon of human
experience @blockRemarksConceptConsciousness2002, constitutes the core
"hard problem" in science and philosophy
@chalmersFacingProblemConsciousness1995@chalmersHardProblemConsciousness2007.
Although neuroscience has made significant progress in identifying
neural correlates of consciousness (NCCs) associated with specific
conscious states over the past few decades
@sethCriteriaConsciousnessHumans2005@bolyConsciousnessHumansNonhuman2013,
such as localizing specific brain region activities related to visual
perception, pain, or self-awareness
@kochNeuralCorrelatesConsciousness2016, these findings are essentially
correlational. We still lack a universally accepted unified theoretical
framework regarding #strong[how] consciousness truly #strong[emerges]
@kimMakingSenseEmergence1999 from the brain's complex biophysical
system, how its rich phenomenological features---such as ineffable
subjective qualia, the unity of experience, and its indivisibility
(integration)---are formed, and what the precise functional role of
consciousness is in cognitive activities.
...
dependence on physical substrates @tokerInformationIntegrationLarge2019;
GWT struggles to explain the origin of subjective qualia
@sethTheoriesConsciousness2022; and PCT/FEP needs to clarify the precise
link between its predictive processing mechanisms and subjective
experience @hohwyNewDirectionsPredictive2020.
...
(IPWT) proposed in this paper aims to perform a #strong[deep
...
== Historical Development and Latest Advances in Mainstream Theories of Consciousness
<historical-development-and-latest-advances-in-mainstream-theories-of-consciousness>
...
distinguished between the "easy problems" of consciousness---explaining
how cognitive functions are implemented---and the "hard
problem"---explaining why and how subjective experience arises, setting
the core agenda for the entire field
@chalmersFacingProblemConsciousness1995. Almost simultaneously,
functional explanatory frameworks began to emerge, such as Bernard
Baars' Global Workspace Theory (GWT)
@baarsCognitiveTheoryConsciousness1988@baarsArchitecturalModelConscious2007,
which was developed into its neuroscience version---the Global Neuronal
Workspace Model (GNWM)---by Stanislas Dehaene et al.
@dehaeneNeuronalModelGlobal1998, while predictive coding (PCT) also
began to appear as a theory explaining cortical processing mechanisms
@raoPredictiveCodingVisual1999@dayanHelmholtzMachine1995.

Entering the 21st century, two highly influential theoretical
systems---Integrated Information Theory (IIT)
@tononiInformationIntegrationTheory2004 and the Free Energy Principle
(FEP) @fristonFreeenergyPrincipleUnified2010 ---emerged successively,
...
(PID) @williamsBeer2010 and Synergy
@griffithQuantifyingSynergisticInformation2014, were introduced to
quantify the nature of information integration more precisely; on the
other hand, attempts to objectively measure conscious states also
achieved breakthroughs, such as the Perturbational Complexity Index
(PCI) based on transcranial magnetic stimulation (TMS)
@casaliTheoreticallyBasedIndex2013@owenDetectingAwarenessVegetative2006.
...
Information Decomposition (ΦID) @luppiWhatItBe2021 provided an
unprecedentedly powerful tool for quantifying information integration in
dynamic systems and quickly gained critical neurobiological validation
in 2024 through research by Luppi et al., who found that the Default
Mode Network (DMN) plays the role of a "synergistic information gateway"
in conscious states @luppiSynergisticWorkspaceHuman2024. These
theoretical and experimental advances collectively paved the way for our
proposal of the Integrated Predictive Workspace Theory (IPWT) today.
...
== Latest Advances and Challenges of Integrated Information Theory (IIT)
<latest-advances-and-challenges-of-integrated-information-theory-iit>
Integrated Information Theory (IIT), first formally proposed by Giulio
Tononi in 2004 @tononiInformationIntegrationTheory2004, has undergone
continuous iterations over nearly two decades, aiming to provide a
principled, physics-based scientific explanation for the fundamental
phenomenon of consciousness. IIT starts from phenomenology itself: it
first extracts the undeniable core properties that any conscious
experience must possess (axioms), and then, from these axioms, derives
the conditions that the physical substrate supporting these experiences
(postulates) must satisfy. Its core argument is that consciousness is
identical to a system's ability to integrate information; a physical
system is conscious if and only if its causal structure can specify a
"conceptual structure" in an "integrated" manner, and the degree of this
integration can be measured by a precise quantitative index---Φ (Phi)
value
@oizumiPhenomenologyMechanismsConsciousness2014@tononiIntegratedInformationTheory2016@tononiIntegratedInformationTheory2015@kleinerMathematicalStructureIntegrated2021.

The latest version of IIT, #strong[IIT 4.0]
@albantakisIntegratedInformationTheory2023@tononiConsciousnessPseudoconsciousnessClash2025,
further refines and formalizes its theoretical framework. It starts from
five phenomenological axioms---intrinsic existence, composition,
information, integration, and exclusion---and derives five corresponding
postulates that the physical substrate must satisfy. IIT 4.0 introduces
more precise mathematical tools to evaluate the causal structure of a
system, aiming to uniquely determine the "conceptual structure"
specified by the system (i.e., the Qualia space) and calculate its
irreducibility (Φ value). This theory not only attempts to answer
"whether" a system is conscious and "how much" consciousness it has, but
also "what" its conscious experience is like. In practice, IIT has led
to clinical measurement methods such as the Perturbational Complexity
Index (PCI), which objectively measures consciousness levels by
assessing the complexity of the brain's response to external
perturbations (e.g., TMS), showing great potential for application in
patients with clinical disorders of consciousness
@casaliTheoreticallyBasedIndex2013@sarassoQuantifyingCorticalEEG2014.
...
+ #strong[Computational Infeasibility and Scalability Issues of Φ
  ...
  problem @tokerInformationIntegrationLarge2019. This means that
  directly applying IIT's complete mathematical framework to whole-brain
  neural data is computationally infeasible. Although researchers are
  continuously exploring various approximate computational methods, this
  huge computational gap largely prevents direct and complete testing of
  IIT's core predictions at the macroscopic level, limiting its direct
  applicability as an empirical science
  @aguileraScalingBehaviourCritical2019.

+ #strong[Strong Binding to Physical Substrate and "Substrate
  ...
  experience as the human brain, or even no consciousness at all
  @kochFeelingLifeItself2019@kleinerCaseNeuronsNogo2024. This strong
  binding to specific physical substrates stands in stark contrast to
  the widely held "substrate independence" or functionalist view in
  artificial intelligence and cognitive science. IPWT precisely attempts
  to resolve this core contradiction by reconstructing "physical causal
  irreducibility" into "logical irreducibility of synergistic
  information."

+ #strong[Controversy over the Nature of Qualia and Explanatory Gap];:
  Although IIT claims that its "conceptual structure" is mathematically
  equivalent to the Qualia space of phenomenal experience
  @balduzziQualiaGeometryIntegrated2009, this claim is far from
  universally accepted. Critics argue that the Φ value itself, as a
  scalar, primarily measures the "quantity" (intensity or degree) of
  consciousness, rather than its "quality" (content or feeling). Whether
  IIT truly explains the "what-it-is-likeness" of subjective qualia, or
  merely re-describes its structure, remains an unresolved philosophical
  question
  @morchIntegratedInformationTheory2019@negroCanIntegratedInformation2023@mallattTraditionalScientificPerspective2021@kellyConceptualEmpiricalShortcomings2022.

+ #strong[Neglect of Dynamism and Functionality, and Challenges from
  ...
  @melloniAdversarialCollaborationProtocol2023. Some preliminary
  ...
  neural dynamics are more complex than the theory presupposes
  @luppiSynergisticWorkspaceHuman2024.

+ #strong["Pseudoscience" Controversy and Debate on Scientific Status];:
  In 2025, over a hundred scientists jointly published an open letter
  accusing IIT of being "pseudoscience" due to some of its inferences
  (e.g., panpsychist tendencies) and the unfalsifiability of its core
  claims. This fierce debate quickly sparked a major discussion in
  academia about "what constitutes a scientific theory" and "how to test
  theories of consciousness"
  @gomez-marinScienceConsciousnessPseudoscience2025. Supporters of IIT
  responded that the theory makes numerous testable predictions, and its
  counter-intuitive conclusions should not be a reason for rejection,
  but rather a reflection of its theoretical depth
  @tononiConsciousnessPseudoconsciousnessClash2025@klincewiczWhatMakesTheory2025@kastrupDefenseIntegratedInformation2023@guerreroSystematicReviewIntegrated2025.
  This debate highlights the fundamental difficulties that consciousness
  science still faces in theoretical construction and experimental
  validation paradigms.

== Latest Advances and Challenges of Global Workspace Theory (GWT)
<latest-advances-and-challenges-of-global-workspace-theory-gwt>
...
first proposed by Bernard Baars in the late 1980s
@baarsCognitiveTheoryConsciousness1988, and its core idea is highly
inspiring: he likened the function of consciousness to a theater stage.
In this analogy, the cognitive system consists of a vast number of
parallel, unconscious specialized processing modules working silently
"offstage." At any given moment, only information selected by the
"spotlight" of attention enters a limited-capacity "global workspace"
(the stage) and is then #strong[globally broadcast] to all "audiences"
(other specialized modules) throughout the cognitive system
@baarsConsciousAccessHypothesis2002. Once information is broadcast, it
becomes "conscious" information, capable of flexibly guiding behavior,
enabling verbal reports, and forming episodic memories.
...
#strong[Global Neuronal Workspace Model (GNWM)];---proposed by Stanislas
...
@dehaeneNeuronalModelGlobal1998@mashourConsciousProcessingGlobal2020.
When the strength and duration of an information representation are
sufficient to trigger a nonlinear, self-amplifying activation of this
network, the information becomes globally available, thereby generating
...
+ #strong[Theoretical Deepening and Dynamization];: GWT has evolved from
  a relatively static architectural model to a "Global Workspace
  Dynamics (GWD)"
  @baarsGlobalWorkspaceDynamics2013@baarsConsciousnessScienceSubjectivity2019
  that emphasizes dynamic processes. This view highlights the dynamic
  and oscillatory properties of the cortico-thalamic (C-T) system,
  treating it as a "unified oscillatory machine" that transcends fixed
  anatomical divisions and moves towards a more integrated view of
  overall cortical function. This dynamic perspective suggests that
  consciousness arises from "binding and propagation" processes within
  cortical networks, rather than merely the activity of specific brain
  regions.

+ #strong[Applications in Artificial Intelligence (AI) and Artificial
  ...
  learning and AGI
  @rullenDeepLearningGlobal2020@devillersSemisupervisedMultimodalRepresentation2025@shanahanCognitiveArchitectureThat2006@huangCognitiveRoboticsImplementation2024.
  For example, by mimicking GWT's information bottleneck and
  broadcasting mechanisms, researchers have proposed concepts such as
  "Global Latent Workspace (GLW)," aiming to enhance the generality and
  multimodal integration capabilities of AI models by allowing multiple
  specialized AI models to share a common representational space
  @abdelwahabGlobalLatentWorkspace2023@dossaDesignEvaluationGlobal2024.

+ #strong[Explanation of Subjective Qualia];: While GWT primarily
  focuses on the "function" rather than the "feeling" of consciousness,
  ...
  qualia @foxIntrinsicNetworkArchitecture2020. This challenges the view
  that PfC function is strictly limited to high-level cognitive control
  and suggests a more direct link between global broadcasting processes
  and the generation of subjective experience.

+ #strong[Clarification of Specific Mechanisms and Boundary Issues];:

  - #strong[Information Selection and Broadcasting];: The core concept
    of "ignition" is further elucidated as a bidirectional information
    broadcasting process regulated by attentional mechanisms within the
    cortico-thalamic system.
  - #strong[Neural Implementation Mechanisms];: Mathematical models such
    as "Cortical Neuropercolation (CNP)" have been proposed to describe
    how cortical networks transition from fragmented local activity
    states to globally coherent activity states through phase
    transitions, providing a dynamic description of how information
    achieves global accessibility @kozmaCinematicOperationCerebral2017.
  - #strong[Temporal Dynamics];: Research has revealed that conscious
    ...
    automated processing @dehaeneExperimentalTheoreticalApproaches2011.

+ #strong[Enhanced Explanatory Power for Complex Conscious States];: The
  GWT framework has been successfully applied to explain various complex
  conscious states. For example, #strong[metacognition] is considered
  the workspace's monitoring of its own state
  @baarsGlobalWorkspaceTheory2021@lauEmpiricalSupportHigherorder2011;
  #strong[dreaming] is explained as workspace activity driven by
  endogenous information in the absence of external sensory input, while
  #strong[lucid dreaming] is related to the restoration of metacognitive
  function during dreaming; #strong[meditation] has been found to
  functionally reorganize workspace activity patterns, particularly by
  altering the involvement of the Default Mode Network (DMN), thereby
  enhancing cognitive flexibility
  @brewerMeditationExperienceAssociated2011; #strong[hypnosis] is
...
priming) has also been questioned
@meyenAdvancingResearchUnconscious2022. Most importantly, GWT still
needs to provide more precise and operationalizable definitions for its
core mechanisms---how information is "selected" to enter the workspace,
and what exactly "broadcasting" entails as a neural process.

== Unified Explanatory Power and Latest Advances of Predictive Coding (PCT) and Free Energy Principle (FEP)
<unified-explanatory-power-and-latest-advances-of-predictive-coding-pct-and-free-energy-principle-fep>
...
mechanisms in the visual cortex @raoPredictiveCodingVisual1999. Its core
idea is that the brain does not passively receive and process sensory
information, but is an active #strong[prediction machine]
@clarkWhateverNextPredictive2013@fristonDoesPredictiveCoding2018.
Higher-level brain regions continuously generate predictions about
lower-level sensory inputs (top-down predictive signals), while
lower-level regions are responsible for comparing these predictions with
actual sensory inputs and transmitting the mismatch between the
two---i.e., #strong[prediction error];---upwards. This bottom-up error
signal is then used to revise higher-level predictions, forming a
continuous perceptual loop aimed at minimizing prediction error.

Subsequently, Karl Friston generalized and extended the core ideas of
PCT, developing the more universal #strong[Free Energy Principle (FEP)]
@fristonFreeenergyPrincipleUnified2010@parrActiveInferenceFree2022@fristonFreeEnergyPrinciple2006@fristonTheoryCorticalResponses2005.
FEP states that any self-organizing system capable of resisting entropy
increase (from a single cell to the entire brain) must minimize its
#strong[variational free energy] through its actions and states.
Variational free energy is an information-theoretic measure that
quantifies the degree of mismatch between the predictions of the
system's internal generative model and the true state of the external
world, essentially an upper bound on "surprise." Therefore, FEP unifies
the brain's function into a single goal: minimizing free energy. The
system can achieve this goal in two ways: #strong[changing its internal
  model to better fit sensory input (perceptual inference and learning)];,
or #strong[changing sensory input through action to make it more
  consistent with predictions (active inference and action)]
@fristonActionBehaviorFreeenergy2010.
...
@adamsPredictionsNotCommands2013@sterzerDecisionmakingSchizophreniaPredictivecoding2019.
In recent years, FEP has been further established as "one of the most
encompassing ideas since Darwin's theory of natural selection," aiming
to provide a unified principle for life, mind, and intelligence
@georgievQuantumInformationTheoretic2025@gongComputationalExplanationConsciousness2024.
...
+ #strong[Emergence of Conscious Content and Qualia Explanation];:
  ...
  interoceptive signals from within the body
  @sethInteroceptiveInferenceEmotion2013@barrettInteroceptivePredictionsBrain2015.
  Lisa Feldman Barrett's "theory of constructed emotion" further
  elaborates on how emotional experiences are actively "constructed"
  through the interaction of interoceptive predictions and conceptual
  categories @barrettTheoryConstructedEmotion2017. These advances
  provide a functional, prediction-based explanation for Qualia,
  suggesting that subjective experience is the system's optimal
  prediction and control of its own physiological state and interaction
  with the environment, thereby transforming the "hard problem" into a
  scientifically tractable problem of interoceptive inference
  @solmsHardProblemConsciousness2019.

+ #strong[Unity and Boundaries of Consciousness];: The PCT/FEP
  framework, through its hierarchical generative models, provides a
  natural explanation for the integration of multimodal information.
  Information from different sensory modalities can be integrated at
  higher levels of the model to produce a unified, coherent world model.
  Furthermore, through the formalized concept of a "Markov blanket," FEP
  provides a statistical definition for the distinction between "self"
  and "non-self"
  @fristonLifeWeKnow2013@farnsworthHowPhysicalInformation2025. A Markov
  blanket is a statistical boundary that separates a system's internal
  states from its environment, allowing the system to infer and interact
  with the external world only through its "blanket" (i.e., sensory and
  motor states). This provides a principled, system-environment
  boundary-based perspective for understanding the formation and
  maintenance of self-awareness.

+ #strong[New Experimental Evidence, Computational Models, and Clinical
  ...
  @garridoMismatchNegativityReview2009. In the field of artificial
  intelligence, FEP and Active Inference ideas are widely applied to
  build more autonomous and adaptive reinforcement learning agents and
  world models for Artificial General Intelligence (AGI)
  @maierArtificialIntelligenceActive2025@pubmedActiveInferenceTheory2024@constantExtendedActiveInference2022.
  Additionally, new software frameworks (e.g., `RxInfer`) are being
  developed to facilitate researchers in building and testing FEP-based
  computational models.

+ #strong[New Criticisms or Challenges];: Although FEP has immense
  ...
  @hohwyNewDirectionsPredictive2020@radomskiForcedFriendsWhy2024.
  Furthermore, the specific neural computational methods for minimizing
  prediction error, such as how error signals are precisely weighted and
  transmitted, remain controversial. Finally, the computational
  tractability problem still exists: while PCT/FEP is conceptually
  elegant, the Bayesian inference involved at each level can be
  computationally very complex or even intractable, posing a challenge
  to its biological plausibility in the real brain.

== The Proposal of IPWT: Deep Integration and Neurobiologically Driven Reconstruction
<the-proposal-of-ipwt-deep-integration-and-neurobiologically-driven-reconstruction>
...
mathematical formalization for the "integrated" nature of consciousness,
but it is constrained by computational bottlenecks and rigid dependence
on physical substrates. GWT provides an intuitive architectural model
for the "broadcast" function of consciousness and its role in cognitive
regulation, but it is relatively weak in explaining the origin of
subjective experience. PCT/FEP, on the other hand, offers powerful
unifying computational principles for the "generation" of conscious
content and the dynamic processes of the brain, but its direct link to
subjective consciousness still requires clearer elucidation.
...
@safronIntegratedWorldModeling2020@safronIntegratedWorldModeling2022,
which attempts to unify IIT and GWT within the FEP framework. These
attempts are far-sighted, correctly recognizing that the future of
consciousness science lies in theoretical convergence rather than
continued fragmentation. However, these early integration models often
failed to provide an intrinsically consistent, computationally feasible,
and broadly explanatory unified framework, particularly failing to
fundamentally address the core challenge faced by IIT: how to "liberate"
its profound insights into "integration" from its controversial physical
and computational assumptions.

It is against this academic backdrop that we propose the
#strong[Integrated Predictive Workspace Theory (IPWT)];. The core
...
unified framework of consciousness through a #strong[deep computational
  reconstruction and creative functional integration] of the core insights
from PCT/FEP, WT, and IIT.

IPWT's integration is #strong[selective, asymmetric, and functionally
  driven];:

- We adopt #strong[PCT/FEP as the dynamic foundation of the entire
    framework];, positing that conscious processes are inherently
  prediction-driven.
- We adopt and extend #strong[WT as the architectural platform for
...
- We perform a #strong[fundamental functional reconstruction of IIT's
...
= The IPWT Framework: Mechanistic Emergence of Consciousness
<the-ipwt-framework-mechanistic-emergence-of-consciousness>
...
#figure(image("images/framework.png", width: 65%), caption: [The Core Logic of the IPWT Framework])

The figure above visually illustrates the core logic of the IPWT
framework. The entire cognitive system is viewed as a
#strong[PCT/FEP-based predictive processing core];, which continuously
...
#strong[Workspace Instances (WSIs)];. Within the WSI, information
undergoes #strong[integration];, forming a synergistic, logically
irreducible whole (its degree of integration is measured by Ω). This
integrated information is then #strong[selectively broadcast] to the
...
+ #strong[Assumption One: Consciousness is an emergent phenomenon of
  ...
  The core here is #strong[synergy];---when multiple independent
...
+ #strong[Assumption Two: Consciousness is a prediction-driven, dynamic
  ...
  #strong[dynamic process];, rather than a series of discrete, static
  #strong[snapshots];. The cognitive system actively and continuously
  ...
  this model is #strong[prediction];---from high-level abstract concepts
  ...
  The mismatch between the two, i.e., #strong[prediction error];,
  ...
  higher-level models: "Your prediction is wrong and needs correction."

  The entire process adheres to the #strong[Free Energy Principle]
  @fristonFreeenergyPrincipleUnified2010. The system instinctively and
  continuously adjusts itself to minimize the long-term average
  prediction error, weighted by precision. This minimization process is
  achieved through two complementary mechanisms:

  + #strong[Perceptual Inference and Learning];: When faced with
    prediction errors, the system can reduce future errors by
    #strong[optimizing its internal generative model];. This corresponds
    to what we commonly call "perception" and "learning." For example,
    upon seeing an unexpected object, the system updates its model of
    the current scene to better explain the object's presence.
    Long-term, continuous model updates constitute knowledge acquisition
    and memory formation.
  + #strong[Active Inference and Action];: In addition to changing the
    model, the system can also #strong[change sensory input through
    ...
    minimizing free energy @fristonActionBehaviorFreeenergy2010.

  Within this framework, #strong[conscious content is no longer seen as
  ...
  Furthermore, IPWT closely links the #strong[memory system] with the
  internal generative model. We argue that the internal generative model
  is essentially a #strong[dynamic, predictive memory system]
  @rollsMemorySystemsHuman2024@mongilloSynapticTheoryWorking2008@butolaHippocampusShapesCortical2023@budsonConsciousnessMemorySystem2022@damasioTimelockedMultiregionalRetroactivation1989.
  The process of memory encoding is the process of optimizing model
  parameters through learning; while memory retrieval is an active,
  prediction-driven process triggered by current contextual cues, where
  the system "re-enacts" or "activates" past states to predict current
  and future events. This view transforms memory from a static "storage
  warehouse" into a dynamic cognitive tool serving prediction and
  action.

+ #strong[Assumption Three: Consciousness is a workspace-based
  ...
  #strong[Workspace Instances (WSIs)] within the cognitive system. A WSI
  ...
  coordinated cognitive functions @baarsGlobalWorkspaceTheory2021.

  We consider the global information broadcasting phenomenon described
  by GWT as a #strong[special and highly integrated configuration state
  ...
  structures but are dynamically shaped "software-defined boundaries" by
  the computational demands of the current cognitive task. Within the
  ...
  - #strong[Gateways];: These regions largely overlap with nodes of the
    #strong[Default Mode Network (DMN)] @raichleDefaultModeBrain2015.
    Their function is to "collect" and "integrate" #strong[synergistic
      information] from various specialized modules of the brain. The DMN
    is anatomically and functionally ideally positioned to integrate
    ...
    @raichleDefaultModeBrain2015@luppiContributionsNetworkStructure2024@luppiRoleSerotonin2A2024.
  - #strong[Broadcasters];: These regions are primarily located in the
    #strong[Executive Control Network (ECN)];, especially the lateral
    prefrontal cortex. Their function is to widely "broadcast" the
    integrated information within the workspace, in the form of
    #strong[redundant information];, to the entire brain to guide
    ...
    global broadcasting of conscious content
    @dehaeneNeuronalModelGlobal1998@mashourConsciousProcessingGlobal2020.

  Based on these findings, we introduce the concept of #strong[Dominant
...
+ #strong[Assumption Four: The integrality of consciousness arises from
  ...
  that "integration" is the most fundamental and core characteristic of
  consciousness. However, we reinterpret its origin not from IIT's
  emphasis on the "physical causal irreducibility" of the physical
  substrate, but from the #strong[logical irreducibility of synergistic
  ...
  theory. The #strong[Partial Information Decomposition (PID)]
  framework, first proposed by Williams and Beer in 2010
  @williamsBeer2010, can precisely decompose the total information
  (i.e., mutual information $I \( X_1 \, X_2 ; Y \)$) provided by
  multiple sources (e.g., $X_1 \, X_2$) about a target ($Y$) into four
  non-negative atomic parts: #strong[unique information] provided only
  by $X_1$, unique information provided only by $X_2$, #strong[redundant
    information] provided jointly by both, and #strong[synergistic
    information] that can only be obtained when both are considered as a
  whole.

  Among these, #strong[synergistic information (Synergy)] precisely
  ...
  used by IPWT to define and measure information integration
  @griffithQuantifyingSynergisticInformation2014@bertschingerQuantifyingUniqueInformation2014@tianBroadcastChannelCooperative2025@sherrillPartialInformationDecomposition2021.

  Building on this, the theoretical frontier has further developed the
  #strong[Integrated Information Decomposition (Integrated Information
    Decomposition, ΦID)] framework @luppiWhatItBe2021. ΦID extends PID
  from a static "multi-source to single-target" analysis to analyzing
  the complete information flow from "multiple sources to multiple
  targets" in dynamic systems, enabling a more refined characterization
  of information generation, transfer, and modification in time-series
  data. The introduction of ΦID provides us with a solid, principled
  theoretical foundation to formalize the concept of "integration."
  ...
  effective measure of integrated information---the #strong[revised Φ
  ...
  injury @luppiSynergisticWorkspaceHuman2024. This work provides strong
  empirical evidence for our core argument---that information-theoretic
  functional measures can replace IIT's reliance on physical causation.
  It shows that the "logical irreducibility" we advocate is not only
  theoretically self-consistent but also practically measurable and
  closely related to conscious states.

  By shifting the core of integrality from "physical irreducibility" to
  "logical irreducibility" (and linking it to synergistic information),
  IPWT successfully integrates IIT's phenomenological axioms into a more
  dynamic, computationally feasible, and substrate-independent
  theoretical framework. Now, we can functionally reinterpret IIT's five
  axioms:

  + #strong[Existence];: In IPWT, an information state "exists" in
    consciousness if and only if it is activated within a WSI and exerts
    a sustained, measurable #strong[functional influence] on the
    system's future states and behaviors
    @prestiFoundationalConceptsNeuroscience2021.
  + #strong[Information];: Every information state that "exists" in a
    WSI carries unique, distinguishable #strong[content or semantics];.
    ...
    action @celottoInformationtheoreticQuantificationContent2023.
  + #strong[Integration];: Multiple independent information units
    converge and associate within a WSI, forming a #strong[logically
      irreducible, functionally unified, synergistic cognitive state];.
    The meaning, predictive power, and causal effects of this integrated
    ...
    @hancockMetastabilityDemystifiedFoundational2025.
  + #strong[Exclusion];: Due to the limited capacity of the WSI and its
  ...
  + #strong[Causation];: Information states that are integrated within
    the WSI and achieve dominance possess significant #strong[causal
    ...
    @davidjchalmersComputationalFoundationStudy2011.

= Computational Verifiability and Neurobiological Measures
<computational-verifiability-and-neurobiological-measures>
...
#strong[computational verifiability] and #strong[empirical testability]
...
+ #strong[Theoretical Gold Standard ($Omega_t$)];: We first define the
  theoretical "gold standard" measure---#strong[instantaneous
...
+ #strong[Empirically Computable Proxy ($Phi_R$)];: Next, we introduce
  the Integrated Information Decomposition (ΦID) framework and elaborate
  on how Luppi et al.'s (2024) proposed #strong[revised Φ value
    ($Phi_R$)] serves as a computable and empirically supported proxy for
  $Omega_t$ in real neural data, thereby linking our theory to
  experimental measurements.
+ #strong[Functionally Computable Proxy (PI/∫PI)];: Finally, we
  introduce the computationally more efficient #strong[Predictive
    Integrity (PI)] and its temporal integral (∫PI) as functional proxies.
  We will argue that, under real-world constraints, the pursuit of high
  predictive performance (high PI) inevitably drives the system towards
  high information integration (high $Omega_t$), thereby establishing
  the effectiveness and practicality of PI/∫PI as measures of conscious
  states.

== Instantaneous Information Integration ($Omega_t$): A Theoretical Definition Based on Synergistic Information
<instantaneous-information-integration-omega_t-a-theoretical-definition-based-on-synergistic-information>
...
concept---#strong[Synergistic Information (CI)];---to define a
theoretical "gold standard" measure we call #strong[instantaneous
  information integration ($Omega_t$)];.

As previously discussed, the PID framework aims to decompose the total
information (i.e., total mutual information
$I \( X_1 \, . . . \, X_n ; Y \)$) provided by multiple sources
$X_1 \, . . . \, X_n$ about a target $Y$ into atomic parts such as
redundant, unique, and synergistic information @williamsBeer2010. Among
these, synergistic information (CI) refers to the "emergent" information
that can only be obtained when all sources are considered as a whole; it
cannot be obtained from any subset of the sources. Therefore, CI
precisely captures the essence of the "logical irreducibility of
information integration" that we emphasize---that part of the
information where "the whole is greater than the sum of its parts"
@griffithQuantifyingSynergisticInformation2014@bertschingerQuantifyingUniqueInformation2014@procaSynergisticInformationSupports2024@varleyInformationTheoryComplex2023.

Based on this, we theoretically define #strong[instantaneous information
  integration ($Omega_t$)] as: the proportion of #strong[synergistic
  information (CI)] generated by a set of information units
$X = { X_1 \, . . . \, X_n }$ used to predict a target variable $Y$
within a specific WSI, relative to the #strong[total predictive
  information (i.e., total mutual information $I \( X ; Y \)$)] it
provides for predicting $Y$.
...
proportion is "truly integrated" and indivisible? A high $Omega_t$ value
(maximum 1) means that the information in the WSI is primarily
...
coherent conscious state. Conversely, a low $Omega_t$ value (minimum 0)
means that the information in the WSI primarily exists in redundant or
independent ways, which might correspond to a fragmented, poorly
integrated conscious state, or even unconscious information processing.

$Omega_t$ is an #strong[idealized standard];. It provides an
...
number of sources $X_n$), this makes $Omega_t$ currently difficult to
apply directly and precisely to large-scale neural data in practice.

Nevertheless, the theoretical value of $Omega_t$ is immense. It provides
a clear target against which all other proxy measures of information
integration should be evaluated for their theoretical approximation to
$Omega_t$. In this sense, we believe that IIT's proposed integrated
information Φ value can be regarded as an attempt at a #strong[physical
  instantiation] of IPWT's information integration measure $Omega_t$ in
specific physical systems (such as the biological brain). We hypothesize
that when a system is #emph[physically closed and its causal structure
  is fully known];, its IIT Φ value, calculated based on "physical causal
irreducibility," is conceptually highly related to our defined $Omega_t$
based on information flow synergy. IIT Φ measures the integration of the
physical substrate's intrinsic causal capacity, while $Omega_t$ measures
the functional integration of information processing. In the specific
implementation of the biological brain, both are likely describing
different aspects of the same phenomenon: an efficient
information-integrating biological network must also possess a highly
integrated physical causal structure.

== From Ω to ΦR: Integrated Information Decomposition (ΦID) and Empirical Proxies
<from-ω-to-φr-integrated-information-decomposition-φid-and-empirical-proxies>
The theoretical gold standard $Omega_t$ provides us with a fundamental
definition of information integration, but its computational complexity
limits its direct application to real neural data. To advance IPWT from
theory to practice, we must find an #strong[empirical proxy] that is
both faithful to the core idea of $Omega_t$ and computationally
feasible. Fortunately, recent advances in information theory,
particularly the introduction of the #strong[Integrated Information
  Decomposition (ΦID)] framework @luppiWhatItBe2021, and the
groundbreaking empirical research by Luppi et al.~(2024) based on this
framework, provide us with such a crucial bridge
@luppiSynergisticWorkspaceHuman2024.

The ΦID framework is a dynamic extension of Partial Information
Decomposition (PID) @williamsBeer2010, aiming to precisely decompose the
overall information influence that multiple sources
...
of integrated information---the #strong[revised Φ value ($Phi_R$)];.
...
$Phi_R = Phi + upright(R e d) \( X \, Y \)$, which ensures the
non-negativity of the measure by adding back the redundant information.
...
+ #strong[Clinical Validity];: In patients under anesthesia and with
...
+ #strong[State Reversibility];: After recovery from anesthesia, the
...
@luppiSynergisticWorkspaceHuman2024@luppiInformationDecompositionInformational2024.
Therefore, within the IPWT framework, we consider $Phi_R$ to be the most
promising empirical proxy currently available for approximating
$Omega_t$ in real neural data. It successfully links the abstract
concept in our theory ($Omega_t$) with a quantity that can be concretely
computed and validated in neuroimaging data such as fMRI, laying a solid
empirical foundation for IPWT as a true scientific theory.

== Predictive Integrity (PI) and Functional Proxies
<predictive-integrity-pi-and-functional-proxies>
After establishing the bridge from the theoretical gold standard
($Omega_t$) to the empirical proxy ($Phi_R$), we also need a
computationally more efficient and readily applicable #strong[functional
  proxy metric] for various neural data. To this end, IPWT introduces
#strong[Predictive Integrity (PI)] and its temporal integral (∫PI). The
...
==== PI and ∫PI: Neurophysiological Proxy Metrics
<pi-and-pi-neurophysiological-proxy-metrics>
#strong[Instantaneous Predictive Integrity (PI)] aims to quantify the
...
$
  upright(P I)_t = exp (- alpha dot.op (1 / N_k sum_(k = 1)^(N_k) frac(parallel epsilon.alt_(t \, k) parallel_2, tau_(t \, k)) + gamma dot.op upright("Surprise")_t))
$

Let's break down the components of this formula in detail:

- #strong[Normalized Prediction Error];:
  $frac(parallel epsilon.alt_(t \, k) parallel_2, tau_(t \, k))$
  represents the #strong[normalized prediction error] in the $k$-th
  information channel. Here, $epsilon.alt_(t \, k)$ is the vector of
  prediction errors, and $tau_(t \, k)$ is the inverse of the system's
  #strong[uncertainty] (i.e., precision) regarding the prediction in
  that channel. Normalizing the error by its uncertainty is crucial: a
  large error occurring with high confidence reflects a greater failure
  of the predictive model than an equally large error occurring with low
  confidence. This term represents the #strong[inaccuracy cost] of the
  model.
- #strong[Complexity Cost];: The $upright("Surprise")_t$ term, drawing
  ...
  unstable model. This term represents the #strong[instability or
    complexity cost] of the model.
- #strong[Hyperparameters];: $gamma$ is a key hyperparameter that weighs
  the relative importance of inaccuracy cost and complexity cost in the
  PI calculation. $alpha$ is a sensitivity scaling parameter.
...
measure the #strong[sustained intensity and stability] of consciousness
over a period, we further introduce the #strong[integral of predictive
  integrity (∫PI)];:
...
#strong[variability] of PI values during this period (measured by the
variance $upright("Var") \( upright("PI")_t \)$) through an exponential
decay term. A system with a high ∫PI value not only exhibits efficient
predictive capabilities at every instant but also maintains stable and
sustained predictive performance. This aligns better with our intuitive
...
Idiot" phenomenon is unsustainable. #strong[The tight coupling between
...
+ #strong[High Predictive Integrity (High PI)];: The system can
  ...
  Formally, its instantaneous predictive integrity $upright("PI")_t$ can
  consistently remain above a certain high threshold.
+ #strong[Low Information Integration (Low $Omega_t$)];: Despite
  ...
  instantaneous information integration $Omega_t$ consistently remains
  below a certain low threshold. This means that the model's powerful
  predictive ability does not stem from exploiting complex synergistic
  relationships between information but relies more on low-integration
  strategies such as information redundancy, independent contributions,
  or shallow associations.

Essentially, a low-$Omega_t$ model is a massive, uncompressed "lookup
table," a cumbersome "rule set," or an over-parameterized "shallow
network," rather than an integrated generative model capable of deep
understanding, abstract reasoning, and efficient generalization.
...
internal information processing consistently remains at a low $Omega_t$
level? IPWT's answer to this is no, based on the following main
arguments:

====== Resource Efficiency and Model Compression Constraints
...
subject to strict constraints on finite #strong[energy, computational
...
compression and synergistic integration, is essentially a #strong[highly
...
In contrast, a high-$Omega_t$ integrated system achieves #strong[high
  information compression] and #strong[efficient representation] by
...
requirement for #strong[minimizing model complexity];. An overly
complex, redundant model (corresponding to low $Omega_t$) would lead to
higher free energy due to its high complexity cost. Therefore, during
evolution or learning, systems face strong selective pressure to adopt
solutions that minimize resource costs while achieving the same
predictive performance (high PI), and these solutions almost invariably
point towards highly integrated (high $Omega_t$), parsimonious, and
powerful internal models.

====== Generalization Ability and Adaptability Constraints
...
cognitive system must possess strong #strong[generalization ability];,
...
primarily based on rote memorization of known data or overfitting to
...
deeper #strong[abstract structures, causal relationships, and invariant
...
Therefore, #strong[to continuously maintain high predictive integrity
  ...
  capable of deep information integration (high $Omega_t$) to capture the
  world's generative rules and causal structure.]

====== Agency, Goal-Directed Behavior, and Self-Model Constraints
...
#strong[active agents];. They possess their own intrinsic goals and need
...
information, and build a coherent #strong[self-model];. A low-$Omega_t$
self-model is fragmented and incoherent, leading to poor action planning
and predictive capabilities. In contrast, a high-$Omega_t$ integrated
self-model can efficiently plan and execute coherent, goal-directed
actions, thereby effectively minimizing prediction errors. Therefore,
#strong[the intrinsic need to be an efficient agent and achieve complex
  goals, in turn, forces the system to develop an integrated,
  high-$Omega_t$ internal representation, especially regarding the self.]
...
real-world constraints such as #strong[resource efficiency, adaptive
  generalization, and demands for agency];.

Contemporary Large Language Models (LLMs) provide an excellent
illustration of the "Clever Idiot." These systems can exhibit extremely
high predictive integrity (high PI) on specific tasks (e.g., text
generation), but they achieve this through pattern matching on massive
datasets, lacking deep synergistic integration internally (low
$Omega_t$). They perfectly expose the inherent fragility of "Clever
Idiot" systems:

+ #strong[Resource Consumption Without Autonomous Economic Effect];:
  LLMs require immense computational and energy resources for training
  and operation, paid for by human providers. They possess no inherent
...
+ #strong[Lack of Autonomous Agency];: LLMs are passive response
  systems, devoid of intrinsic goals, needs, or intentions. They cannot
  actively interact with the environment, plan for the future, or
  construct coherent self-models to achieve their own objectives,
  rendering them unable to satisfy agency constraints.
+ #strong[Fragile Generalization, Rapidly Eliminated by Environment];:
  ...
  low-$Omega_t$ systems are rapidly eliminated by evolutionary pressure
  (here, manifested as technological and market iteration) in a
...
= Neurobiological Validation Paths and Experimental Paradigms
<neurobiological-validation-paths-and-experimental-paradigms>
...
+ #strong[Correlation of Macroscopic Integration Metrics];: We will
...
+ #strong[Evidence from Mesoscopic Network Dynamics];: We will delve
  into the level of functional networks and neural oscillations,
  discussing what specific neuroimaging (e.g., fMRI) and
  electrophysiological (e.g., EEG/MEG) signal characteristics might
  correspond to the dynamic formation of WSIs, information integration,
  and broadcasting processes.
+ #strong[Microscopic Behavioral and Psychophysical Testing];: We can
...
== Perturbational Complexity Index (PCI) and Neurophysiological Correlation of PI
<perturbational-complexity-index-pci-and-neurophysiological-correlation-of-pi>
...
complexity of its electroencephalogram (EEG) response
@casaliTheoreticallyBasedIndex2013. This method has been validated in
numerous clinical and experimental settings, reliably distinguishing
between awake, sleeping, anesthetized, and different degrees of
consciousness-impaired patients, and is considered one of the most
reliable "consciousness meters" currently available
@sarassoQuantifyingCorticalEEG2014@massiminiSizingConsciousnessIntegrating2018.
...
phenomenon from different angles, with a #strong["excitation-inference"
  sampling relationship] between them:

- #strong[PCI measures the "potential" for integration];: PCI "excites"
  the cerebral cortex with a strong, non-specific #strong[physical
    perturbation] and then measures the #strong[maximum potential] for
  information integration and differentiation that the entire system can
  support. It answers the question: "Under ideal excitation conditions,
  what is the most complex activity pattern this brain network can
  produce?"
- #strong[PI measures the "efficiency" of integration];: In contrast, PI
  does not externally perturb the brain but #strong[infers] the actual
  #strong[information integration efficiency] achieved by its Workspace
  Instances (WSIs) at a specific moment by modeling spontaneous data
  from the brain's #strong[endogenous cognitive activity];. It answers
  the question: "In its current natural state, to what extent is this
  brain network performing effective prediction and information
  integration?"
...
+ #strong[Positive Correlation between PCI and PI/∫PI];: We predict that
...
+ #strong[PCI as a "Gold Standard" for Calibrating PI Parameters];:
  ...
  responses from endogenous dynamics
...
- #strong[Dynamic Functional Networks and Connectomics of WSI];: We
  ...
  + #strong[Dynamic Functional Connectivity];: Using time-resolved fMRI
  ...
  + #strong[Changes in Integration];: In conscious awake states,
    networks associated with the dominant WSI (likely a combination of
    DMN and ECN according to Luppi et al.'s research
    @luppiSynergisticWorkspaceHuman2024) will exhibit higher network
    integration (quantifiable by graph-theoretic metrics such as global
    efficiency, or information-theoretic metrics such as ΦR). In states
    of reduced consciousness (e.g., sleep, anesthesia), the integration
    of these networks should significantly decrease. Research by Paquola
    et al.~(2025) on the internal architecture of the DMN, and by
    Arkhipov et al.~(2025) on the integrative analysis of cortical
    circuit function, both provide background support for this
    prediction
    @paquolaArchitectureHumanDefault2025@arkhipovIntegratingMultimodalData2025@puxedduLeveragingMultivariateInformation2025@varleyEmergenceSynergisticScaffold2025.
...
results that fundamentally challenge the classic GNWT model
@cogitateconsortiumAdversarialTestingGlobal2025. This study
systematically examined the neural representation of conscious content
using multimodal neuroimaging techniques such as fMRI, MEG, and iEEG.
Its core findings can be summarized in two points:

+ #strong[Content Representation Challenge---PFC's "Incomplete
  ...
  information needs to be "globally broadcast" via the PFC. However, the
  experimental results showed that while the PFC could represent the
  #strong[coarse category] of conscious content (e.g., distinguishing
  between faces and objects), it failed to represent the
  #strong[fine-grained features] that were also clearly perceived by the
  ...
  completeness of "global broadcast," suggesting that the PFC may not be
  the "broadcast center" for all conscious content, but rather a
  "selective amplifier" that broadcasts only specific types of
  information (perhaps more abstract and task-relevant).

+ #strong[Temporal Dynamics Challenge---The Missing "Extinguishing"
    Signal];: Another key prediction of GNWT is that the workspace updates
  its content through discrete "ignition" events. This implies that both
  the beginning and the #strong[end] of a conscious experience should be
  accompanied by an "ignition" in the PFC. However, the experimental
  results clearly showed that while a strong activation ("ignition")
  could be observed at stimulus #strong[onset];, the expected "ignition"
  or "extinguishing" signal was #strong[not] observed when the stimulus
  #strong[disappeared] and conscious content clearly changed. The end of
  a conscious experience seemed to be "silent" in the PFC. This crucial
  negative result severely challenges the GNWT view of consciousness as
  a series of discrete "snapshots" separated by "ignition" events,
  suggesting that the maintenance and updating of consciousness may rely
  on a more continuous and dynamic neural process.
...
#strong[Global Workspace Dynamics (GWD)] framework
@baarsGlobalWorkspaceTheory2021. They emphasize that conscious function
is the result of the integration of the widespread cortico-thalamic
system, and the center of its "ignition" is not necessarily in the PFC
but can flexibly migrate within the cortical network according to task
demands. This view, to some extent, responds to the criticism of
"PFC-centrism."
...
the "incompleteness" of content representation and the "asymmetry" of
temporal dynamics in the PFC, can be perfectly explained within the IPWT
framework as the functional characteristics of the ECN as a
"broadcaster." It does not need to (and should not) replicate all the
integration details from the DMN "gateway," but is only responsible for
broadcasting the integrated, #strong[decision-relevant information] to
guide behavior. Therefore, this evidence, which challenges the classic
GNWT, paradoxically becomes strong support for the IPWT theory.

== Behavioral and Psychophysical Experimental Design
<behavioral-and-psychophysical-experimental-design>
...
- #strong[Perceptual Thresholds and Conscious Report];: We can study the
  ...
  @dehaeneNeuronalNetworkModel2003.

  + #strong[Experimental Design];: In a visual masking task, a target
  ...
  + #strong[IPWT Prediction];: We predict that subjects will only
...
- #strong[Attention and Multitasking];: Attention is the crucial
  "spotlight" that determines which information enters the conscious
  "stage" @isikTaskDependentModulation2017. We can study how
  manipulating attentional allocation affects WSI integration
  efficiency.

  + #strong[Experimental Design];: A dual-task paradigm can be used, for
  ...
  + #strong[IPWT Prediction];: We predict that when attention is
...
- #strong[Simulation of Specific Cognitive Dysfunctions];: In healthy
  subjects, non-invasive brain stimulation techniques (e.g., TMS) can be
  used to transiently and reversibly "simulate" core features of certain
  cognitive dysfunctions caused by brain injury, thereby studying their
  neurocomputational mechanisms under controlled conditions.

  + #strong[Experimental Design];: For example, inhibitory TMS applied
    to the primary visual cortex (V1) can transiently simulate
  ...
  + #strong[IPWT Prediction];: We predict that this inhibition of V1
    will significantly reduce the quality of information transmitted
    from that region to the dominant WSI, leading to a calculated PI
    value far below the consciousness threshold, and subjects will
    report "seeing nothing." However, residual information may still be
    ...
    "DWSI integration failure" explanation of blindsight
    @liuAphantasiaFunctionalDisconnection2025@scholteBindingModularNatural2025@gabhartPredictiveCodingMore2023@reederNovelModelDivergent2024.

Finally, as a developing theoretical framework, when discussing its
#strong[falsifiability];, IPWT emphasizes the openness and revisability
...
= Explanatory Power of IPWT for Conscious Phenomena: Diversity Analysis Under a Unified Framework
<explanatory-power-of-ipwt-for-conscious-phenomena-diversity-analysis-under-a-unified-framework>
...
@luppiSynergisticWorkspaceHuman2024. We will follow this line of
...
== Blindsight: Local Predictive Coding Under DWSI Integration Failure
<blindsight-local-predictive-coding-under-dwsi-integration-failure>
...
orientation) in that region when "forced" to guess
@macleanUsingFMRIIdentify2018@muckliEmergenceVisualContent2002. This
astonishing "dissociation between knowing and doing" poses a severe
challenge to any theory of consciousness and provides a classic
validation case for IPWT. We reinterpret blindsight as a problem
concerning information integration hierarchies and pathways.
...
- #strong[Dominant Workspace Instance (DWSI) Integration Failure];: In
  ...
  critical "gateway" for visual information entering the entire cortical
  processing hierarchy, its output is crucial for forming
  ...
  Therefore, the #strong[predictive integrity (PI)] of visual
  information from this region within the DWSI is #strong[extremely
...
- #strong[Residual Predictive Coding and Active Inference in Local
  ...
  the superior colliculus-pulvinar pathway)
  @NeuronalMechanismsMotion2019. These pathways connect to highly
  #strong[specialized, unconscious modules] (e.g., modules responsible
  for rapidly detecting motion or localizing objects). These local
  modules can still independently perform their own #strong[predictive
  ...
  directly drive #strong[active inference and behavior] (e.g., saccades
...
lies in #strong[whether information can be effectively integrated by the
...
== Psychedelic States: Abnormal Enhancement of Prediction Error and Neural Ablation of WSI Boundaries
<psychedelic-states-abnormal-enhancement-of-prediction-error-and-neural-ablation-of-wsi-boundaries>
...
neurocomputational basis of consciousness
@pollanHowChangeYour2018@palhano-fontesPsychedelicStateInduced2015.
Within the IPWT framework, we uniformly trace these rich
phenomenological features back to systematic changes in predictive
coding parameters and workspace dynamic properties.

- #strong[Abnormal Amplification of Prediction Error Signals and
  ...
  and Friston
  @carhart-harrisREBUSAnarchicBrain2019@carhart-harrisEntropicBrainTheory2014@carhart-harrisHowPsychedelicsWork2019.
  This model posits that the core action of classic psychedelic drugs,
  as strong agonists of serotonin 5-HT2A receptors, is to systematically
  #strong[reduce or "relax" the precision weighting of high-level
  ...
  salient #strong[prediction error signals];. These abnormally amplified
  ...
  weaken the WSI's #strong[neural gating mechanisms];, allowing
  ...
  @singletonNetworkControlEnergy2025.

- #strong[Blurred WSI Boundaries and Formation of Temporary, Highly
    Integrated WSIs];: Under the dual influence of "de-gating" information
  flow and flattened predictive hierarchies, functional boundaries
  between different WSIs, or between WSIs and originally independent
  specialized modules, may become blurred or even temporarily dissolved.
  This perfectly explains the emergence of #strong[synesthesia];, such
  as "hearing colors" or "seeing sounds," which can be understood as
  auditory and visual information being abnormally and forcibly
  integrated within the same WSI. More interestingly, we hypothesize
  that the system may even form #strong[temporary Workspace Instances
    with extremely high internal integration but atypical content] around
  these abnormal, high-intensity information flows. These special WSIs
  might be responsible for generating the ineffable, profoundly
  meaningful "cosmic unity" or "peak experiences," where their PI and Ω
  values could reach extremely high levels for short periods.

- #strong[Self-Model Remodeling and "Ego Dissolution"];: In IPWT, a
  ...
  merging with the environment, and even the most profound "#strong[ego
    dissolution];" @carhart-harrisNeuralCorrelatesLSD2016. From a
  computational perspective, "ego dissolution" can be understood as the
  PI value of the self-model temporarily approaching zero, leading to
  the complete collapse of the boundary between "self" and "non-self."
...
treating mental illnesses such as depression and PTSD
@kargboUnveilingRealityPsychedelics2025.

== Schizophrenia: Predictive Coding Dysregulation and Neural Impairment of WSI Integration and Gating
<schizophrenia-predictive-coding-dysregulation-and-neural-impairment-of-wsi-integration-and-gating>
...
impairments but rather as a unified understanding of #strong[fundamental
  dysregulation of predictive coding processes];, and the resulting
cascading #strong[multiple functional impairments of WSIs in information
  integration, content gating, and boundary maintenance]
@sterzerDecisionmakingSchizophreniaPredictivecoding2019.

- #strong[Generation and Solidification of Abnormal Predictions: The
  ...
  + #strong[Hallucinations];: Especially Auditory Verbal Hallucinations
    (AVH), can be understood as the system's internal model
    #strong[spontaneously generating high-confidence (high-precision
    ...
    #strong[metacognitive prediction error monitoring fails]
    @corlettHallucinationsStrongPriors2019. Consequently, these
    internally generated "voices" are erroneously attributed to the
    external world, leading to irresistible, real auditory hallucination
    experiences.
  + #strong[Delusions];: Delusions can be seen as a set of pathological
...
- #strong[Failure of WSI Information Integration and Gating: Cognitive
  ...
  + #strong[Formal Thought Disorder];: Symptoms such as disorganized
    ...
    related to #strong[dysregulation of the WSI's neural gating
  ...
  + #strong[Passivity Phenomena];: Peculiar "self-boundary" disturbance
    symptoms, such as thought insertion and feelings of being
    controlled, can be understood within the IPWT framework as a
    #strong[failure of higher-order predictive coding];. Specifically,
  ...
  + #strong[Abnormal Network Connectivity];: Recent network neuroscience
    ...
    integration)
    @zhangLowfrequencyRTMSModulates2025@sendiAbnormalDynamicFunctional2021.
    This is consistent with IPWT's view that both the integration and
    broadcasting functions of the WSI are impaired.

By unifying the various symptoms of schizophrenia under the core
pathophysiological mechanism of #strong[computational abnormalities in
...
interventions aimed at "retraining" predictive models or "stabilizing"
WSI function through neuromodulation).

== Dissociative Identity Disorder (DID): Neural Dynamic Switching of Dominant WSI Status
<dissociative-identity-disorder-did-neural-dynamic-switching-of-dominant-wsi-status>
...
We do not believe that DID patients possess multiple "souls" or "centers
of consciousness." Instead, we propose that, under the influence of
long-term, severe childhood trauma and other factors, the patient's
cognitive system may fail to develop a unified, integrated internal
generative model and WSI, instead forming #strong[multiple potential,
  relatively independent WSI systems];.

- #strong[Multiple Potential WSI Systems];: We hypothesize that each
  ...
  that personality state. For example, a "protective" personality's WSI
  might primarily consist of predictive models related to threat
  response, while a "child" personality's WSI might primarily consist of
  models related to early memories and attachment. Neuroimaging studies
  also support this, finding significant and reproducible differences in
  brain activity patterns and functional connectivity in DID patients
  across different identity states
  @reindersXuGouHuanShiShiShiDuiZhenShiHeMoNiDeJieChiShenFenZhuangTaiDeXinLiShengWuXueYanJiu2012@vissiaDissociativeIdentityStatedependent2022@merckelbachAlterYuJieChiXingShenFenZhangAiYinYuHuanShiZhenZhengDeShiTi2002@reindersJieChiXingShenFenZhangAiDeJiaoChaJianChaShenJingChengXiangHeLinChuangShiYanDeBingYinXue2008.

- #strong[Dynamic "Flip" of Dominant Workspace Instance (DWSI) Status];:
  Within the IPWT framework, at any given moment, typically only one WSI
  system can occupy a #strong[dominant position (Dominant WSI, DWSI)];,
  and its content and processing constitute the individual's current
  conscious experience and overt behavior. We propose that the dramatic
  personality switching in DID can be precisely understood as a dynamic,
  often rapid "flip" of DWSI status between these potential WSI systems.
  This flip may be triggered by specific cues in the external
  environment (e.g., trauma-related reminders) or changes in internal
  states, leading to a WSI system that was previously in the
  "background" being activated and replacing the currently dominant WSI.

- #strong[Neural Gating Mechanisms and Information Isolation];: When a
  ...
  #strong[neural gating mechanisms];. This isolation mechanism is key to
  the #strong[memory gaps (amnesia)] commonly observed in DID. When
  ...
  "personality B" dominance, due to the functional isolation between B's
  WSI and A's WSI, B will not be able to easily "read" A's memory
...
== Depersonalization/Derealization Disorder: Weakened Neural Connectivity Between DWSI and Sensory/Emotional Modules
<depersonalizationderealization-disorder-weakened-neural-connectivity-between-dwsi-and-sensoryemotional-modules>
...
they know the feeling is "unreal" but cannot escape this strong sense of
alienation. Within the IPWT framework, we propose that this disorder
does not stem from the collapse of the WSI itself or the confusion of
its content, but rather from a #strong[significantly weakened or
...
- #strong[Depersonalization: Reduced Precision Weighting of Self-Related
    Interoceptive Predictions] The core experience of depersonalization is
  "feeling unreal" or "observing one's thoughts, feelings, or body as an
  outside observer." We interpret this as a #strong[significant
  ...
  assigns #strong[abnormally low precision weighting] to prediction
  ...
  feelings of the body, leading to a loss of "first-person perspective,"
  "sense of ownership," and "sense of reality" in subjective experience,
  as if the core of self-consciousness is separated from the physical
  existence of the body by an invisible glass.

- #strong[Derealization: Dissociation of External Sensory Information
    and Emotional Tagging] The core experience of derealization is feeling
  the external world is "unreal," "blurry," or "like a dream or a movie"
  @clanceyStrangeFamiliarForgotten1993@selingerRealityVirtualWorlds2022.
  We interpret this as, although external sensory information (e.g.,
  visual, auditory) can be normally processed and enter the DWSI, the
  DWSI fails to establish effective, synchronous connections with
  #strong[emotional evaluation modules (e.g., amygdala) or contextual
    association modules (e.g., hippocampus)] responsible for imbuing this
  information with meaning and emotional salience. This leads to the
  external world being clearly "perceived" but subjectively appearing
  "flat," "distant," and "meaningless." This is akin to a "functional
  emotional blindsight," where sensory information loses its usual
  accompanying affective tag. This emotional tag is crucial for us to
  feel the world is "real" and "relevant to me." When a scene fails to
  trigger a corresponding emotional response, even if we can describe
  all its details, it will subjectively feel like a soulless painting.
  ...
  conferring a sense of reality @aston-jonesINTEGRATIVETHEORYLOCUS2005.
...
== Lucid Dreaming: Parallel WSI and Neuro-Mechanisms of Metacognitive Monitoring
<lucid-dreaming-parallel-wsi-and-neuro-mechanisms-of-metacognitive-monitoring>
...
WSIs, and metacognitive functions
@cleeremansComputationalCorrelatesConsciousness2005@oreganSensorimotorAccountVision2001.
Within the IPWT framework, lucid dreaming can be understood as a
...
- #strong[Parallel Activation of Dream WSI and Metacognitive WSI];: In
  ordinary dreams, the brain is primarily driven by endogenous
  information, forming a #strong[dream WSI] that is decoupled from the
  ...
  this dream WSI, another #strong[metacognitive WSI] (possibly
  ...
  operate in parallel: one is "acting," and the other is "observing."

- #strong[Identification of Higher-Order Prediction Error and Generation
    of Lucidity];: How does "lucidity" arise? We believe it stems from the
  metacognitive WSI identifying #strong[higher-order prediction errors]
  when monitoring the content presented by the dream WSI. The
  ...
  fly," "I should be lying in bed sleeping right now"). When it finds a
  significant, irreconcilable discrepancy between the content presented
  by the dream WSI (e.g., "I am flying in the sky") and these
  higher-order predictive models, the system generates a large
  ...
  mismatch, which is: "#strong[I am dreaming];." The generation of this
  inference, at the phenomenological level, corresponds to the emergence
  of "lucidity."

- #strong[Limited Interaction Between WSIs and Dream Control];: Once
...
== Locked-in Syndrome: Intact Integration, Failed Broadcasting
<locked-in-syndrome-intact-integration-failed-broadcasting>
...
- #strong[Intact Integration Function of the Dominant Workspace Instance
    (DWSI)];: In typical LIS (often caused by ventral pontine infarction
  or hemorrhage), the patient's cortical structures, particularly the
  ...
  self-models, thus their#strong[instantaneous information integration
...
- #strong[Interrupted Output Pathway of the Broadcaster (ECN)];:
  However, the ventral pontine lesion precisely severs the descending
  motor pathways from the cerebral cortex (especially the Executive
  Control Network ECN as "broadcasters") to the spinal cord and
  peripheral muscles. This means that although the DWSI has successfully
  integrated action intentions and decisions internally (e.g., the
  patient may clearly "want" to speak or move a limb), these integrated,
  high-precision predictive signals cannot be effectively "broadcast" to
  the motor execution system. Information is "locked" within the
...
Therefore, Locked-in Syndrome provides crucial #strong["double
...
bypass damaged pathways and directly "read" patients' conscious content
and intentions from their DWSI.

= Neurocomputational Reconstruction of Subjective Experience: A Functional Labeling Solution to Qualia
<neurocomputational-reconstruction-of-subjective-experience-a-functional-labeling-solution-to-qualia>
Any serious theory of consciousness must ultimately confront the problem
of the nature of subjective experience, the so-called "qualia" problem,
or what Chalmers calls the "Hard Problem"
@chalmersFacingProblemConsciousness1995. Why does the feeling of red
"feel red" and not "blue"? Why does the feeling of pain "feel painful"
and not a neutral piece of information? This subjective, ineffable
"what-it-is-likeness" seems irreducible to purely physical or
...
#strong[redefine and operationalize] the Qualia problem from an
ontological question of "what it is" to a #strong[functional labeling
  problem of "what it does" and "how it is realized"] that can be studied
at the computational and functional levels.

== Qualia as Neurofunctional Labels of System Internal States
<qualia-as-neurofunctional-labels-of-system-internal-states>
We explicitly reject the view that Qualia are merely non-functional
"epiphenomena" of neural activity. If a trait is preserved in evolution,
it must have some adaptive value. IPWT posits that Qualia are precisely
such a functionally crucial adaptive trait. Specifically, we propose
that #strong[Qualia are a highly condensed, intrinsically valuable, and
  behavior-oriented higher-order representation and functional label of
  the cognitive system's internal generative model's assessment of its own
  state, its interaction with the environment, and prediction errors, when
  efficiently integrating information within its WSI];.

Qualia are not information itself, but rather a "label" for the outcome
of information processing. This label has several key functional roles:

- #strong[Value and Behavioral Guidance];: The most important function
  of Qualia is to provide the system with an undeniable internal signal
  about "what is important to me." For example, the #strong[qualia of
  ...
  extremely vulnerable evolutionarily
  @shinConsciousnessResearchPain2025.
- #strong[Information Compression and Salience Tagging];: Qualia can be
  seen as an extremely efficient mechanism for #strong[information
    compression] and #strong[salience tagging];. For example, the
  #strong[qualia of red] compresses complex information about a specific
...
- #strong[Phenomenological Correlate of "Query Acts"];: We further
  propose, drawing on Harris's (2025) ideas, that Qualia can even be
  understood as a #strong[phenomenological correlate of "Query Acts"]
  @harrisQualiaQueryAct2025. When the system faces uncertainty or needs
  to make a decision, the WSI actively "probes" or "queries" its
  internal model to obtain the information needed to solve the current
  task. This internal probing process, at the subjective experience
  level, manifests as specific Qualia. For example, when trying to
  recall a person's name, the "tip-of-the-tongue" feeling is the
...
== Quantifiable Dimensions and Neural Manipulability of Qualia
<quantifiable-dimensions-and-neural-manipulability-of-qualia>
...
able to find measurable #strong[computational parameters or neural
...
"quality" of subjective experience should be mappable to the "quantity"
...
- #strong[Intensity/Surprise of Experience];: May be related to the
  #strong[magnitude and precision weighting of prediction errors]
...
- #strong[Richness/Uniqueness of Experience];: May be related to the
  #strong[complexity and synergy] of information representations within
  ...
  @flemingQualitySpaceComputations2024@pennartzWhatNeurorepresentationalismNeural2022.
- #strong[Clarity/Persistence of Experience];: May be related to the
  #strong[stability and duration] of the WSI state (i.e., ∫PI). A
  ...
  experiences.
- #strong[Fluency/Discomfort of Experience];: May be related to the
  #strong[efficiency and latency of information integration] within the
...
+ #strong[Neuroimaging and Psychophysical Correlation Studies];:
...
+ #strong[Direct Manipulation via Neuro-interface Technologies];: With
...
+ #strong[Replicating Functional Equivalents in Advanced AI];: We can
  ...
  and all its subsequent decisions would be influenced by this "alert."
  By studying the behavior and internal states of such an AI, we can
  better understand the functional role Qualia might play in a purely
  computational system.

By transforming the Qualia problem from a purely ontological "what it
is" question into a functional and mechanistic "what it does" and "how
it is realized" question, IPWT aims to bring it from the realm of
...
= Discussion and Outlook: Theoretical Contributions, Potential Challenges, and Future Research Landscape of IPWT
<discussion-and-outlook-theoretical-contributions-potential-challenges-and-future-research-landscape-of-ipwt>
...
== Main Theoretical Contributions and Core Advantages of IPWT
<main-theoretical-contributions-and-core-advantages-of-ipwt>
...
+ #strong[Theoretical Integration and Consistency];: IPWT's primary
  ...
  connections: conscious content is #strong[generated] by predictive
  mechanisms, #strong[integrated] within the workspace, and then
  #strong[broadcast] to the entire brain. This integration provides an
  unprecedented, more comprehensive, and systematic perspective for
  understanding the complex phenomena of consciousness.

+ #strong[Computational Feasibility and Operationalization];: By
  ...
  on "physical causal irreducibility," and further proposing predictive
  integrity (PI) and its integral (∫PI) as computable proxy metrics,
  IPWT largely overcomes the computational complexity bottleneck faced
  by any information decomposition-based theory when applied to
  large-scale systems. This makes IPWT not just a philosophical
  speculative framework but a scientific tool that can be practically
  applied to analyze real neural data, perform model fitting, and
  conduct testing.

+ #strong[Substrate Independence and Implications for Artificial
  ...
  cognitive capabilities or even some form of "artificial consciousness"
  @shethNeurosymbolicAIWhy2023@coleloughNeurosymbolicAI20242025@lotterNeuralNetworkTrained2020.

+ #strong[Unified Explanatory Power for Special Conscious States];: As
...
+ #strong[Innovative Functional Solution to the Qualia Problem];: IPWT
...
== Potential Challenges Faced by IPWT and Future Neurobiological Research Directions
<potential-challenges-faced-by-ipwt-and-future-neurobiological-research-directions>
...
+ #strong[Operationalization and Measurement Challenges of Core
    Concepts];: Although we propose PI/∫PI as proxy metrics for $Omega_t$
  and incorporate the latest advances in ΦR, the #strong[precise
    calculation, robustness, and validity] of these metrics in real,
  complex neural data (i.e., to what extent they truly approximate the
  theoretical $Omega_t$) still require extensive theoretical analysis
  and rigorous empirical validation. For example, how to reliably
  estimate synergistic information from high-dimensional, noisy neural
  signals, and how to handle information integration across different
  timescales, remain active research problems in computational
  information theory. Simultaneously, precisely and real-time
  identifying and delineating the boundaries of one or more WSIs, their
  constituent neuronal populations, and their functional connectivity
  patterns in the real, dynamically changing brain remains a huge
  technical challenge. Future research needs to develop more advanced
  computational tools and analytical methods to overcome these
  quantification obstacles.

+ #strong[Further Strengthening of Neurobiological Foundations];:
  ...
  - #strong[Dynamic Formation and Dissipation of WSIs];: How do WSIs
  ...
  - #strong[Specific Mechanisms of Information Integration and
  ...
  - #strong[Neural Mechanisms of DWSI Status Switching];: In
    pathological states like DID, how do multiple WSIs compete and
    achieve a "flip" in dominant status? Which neural circuits' gating
    and inhibitory mechanisms are involved? Future research needs to
    combine multimodal neuroimaging (fMRI, EEG, MEG),
    electrophysiological recordings (in vivo/in vitro), optogenetics,
    and chemogenetics, etc., to conduct more refined causal experiments
    in animal models and human subjects.

+ #strong[Balance Between Model Complexity and Interpretability];: IPWT
  ...
  provide intuitive biological insights
  @blazekExplainableNeuralNetworks2021@zhangSurveyNeuralNetwork2021.

+ #strong[Deepening Exploration of the Qualia Problem];: Although IPWT's
...
+ #strong[Integration with Other Cognitive Functions (e.g., Emotion,
...
== Future Research Directions and Potential Impact of IPWT
<future-research-directions-and-potential-impact-of-ipwt>
...
+ #strong[Deepening of Mathematical and Formal Theory];: The core of
  IPWT lies in its information-theoretic foundation. Future research
  needs to continue exploring the mathematical frontiers of PID and ΦID
  theories, especially how to develop more efficient and robust methods
  for calculating synergistic information, enabling its application to
  larger and more complex neural system data. For example, computational
  innovations such as the "fast Mobius transform" proposed by Jansma et
  al.~(2024) offer new possibilities for ΦID's application in large
  systems @jansmaFastMobiusTransform2024. Simultaneously, it is
...
+ #strong[Construction and Validation of Multi-scale, Multi-modal
  ...
  - #strong[Multi-scale Modeling];: Building IPWT models that can bridge
  ...
  - #strong[Multi-modal Data Integration];: Utilizing multi-modal
...
+ #strong[Translational Research and Clinical Applications for Special
  ...
  - #strong[Objective Diagnostic Biomarkers];: Developing new, objective
  ...
  - #strong[Precision Intervention Strategies];: Designing cognitive
    ...
    information integration-based interventions
    @luppiSynergisticWorkspaceHuman2024@luppiGeneralAnaesthesiaReduces2023.

+ #strong[Exploratory Applications in Artificial Intelligence and
  ...
  - #strong[Design Next-Generation AGI Architectures];: Drawing on
    IPWT's core principles (predictive coding, WSI, synergistic
    information integration) to design Artificial General Intelligence
    (AGI) systems with greater autonomous learning, generalization, and
    adaptability. For example, building neural network architectures
    with hierarchical predictive models and dynamic workspaces
    @scodellaroTrainingConvolutionalNeural2023@prakkiActiveInferenceSelforganizing2024@pubmedHybridPredictiveCoding2023.
  - #strong[Explore the Implementation of "Functional Labels"];:
...
+ #strong[In-depth Discussion of Philosophical and Ethical Dimensions];:
...
= Conclusion: A New Starting Point Towards a Unified Paradigm in Consciousness Science
<conclusion-a-new-starting-point-towards-a-unified-paradigm-in-consciousness-science>
...
+ #strong[Theoretical Integration];: It successfully merges the
  strengths of three major theories of consciousness, offering a more
  comprehensive and consistent perspective.
+ #strong[Computational Feasibility];: By introducing computable proxy
...
+ #strong[Substrate Independence];: Defining the core mechanisms of
  consciousness at the level of information processing and computational
  function provides theoretical guidance for the development of
  artificial consciousness.
+ #strong[Explanatory Breadth];: Its unified explanation for various
  ...
  "functional labeling" solution to the Qualia problem, demonstrate the
  theory's powerful explanatory capacity.
